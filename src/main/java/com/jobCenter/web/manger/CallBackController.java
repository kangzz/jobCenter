    ...
    public void callBack(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if (JobStatus.ZXCG.getValue() != Integer.valueOf(code)) {
                ...
                sb.append("定时任务[" + jobName + "]执行失败!<br>");
                sb.append("失败原因:" + message + "</br>");
                sb.append("UUID:" + uuid + "</br>");
                JobLinkInfo jobLinkInfo = jobService.getJobLinkInfoById(linkId);
                if (jobLinkInfo != null) {
                    sb.append("jobId:"+jobId+"</br>");
                    sb.append("linkId:"+linkId+"</br>");
                    sb.append("Url地址:"+jobLinkInfo.getJobLink()+"<br>");
                    sb.append("serviceName:"+jobLinkInfo.getServiceName()+"<br>");
                }
