...
(function($) {     
	...
	{
		var opts = $.extend({},$.fn.slideNav.defaults, options);     
		return this.each(function() {  
			var $this=$(this);
			var $clickObj=$(this).find(opts.clickObj).find(opts.clickObjDt);
			
			$clickObj.click(function()
			{
				if($(this).parent().hasClass(opts.activeClass)){
					$(this).parent().removeClass();
				}else{
					$(this).parent().addClass(opts.activeClass).siblings().removeClass();
				}
	...
	$.fn.checkAll = function(options)
	{
		...
		return this.each(function() {  
			var $this=$(this),
				oFrist=$this.find('thead').find('input[type=checkbox]'),
				aCheck=$this.find('input[type=checkbox]');
		
			
			oFrist.live('click',function(){
				var _this = $(this);
...
function setHeight(){
	...
	if(oSlideBar.height() < oBody.height()){
		oSlideBar.css('height',h+'px');
	}else{
		oBody.css('height',oSlideBar.height()+'px');
	}
	
	
	
	$('#leftiframe').css('height',h+'px');
    $('#mainiframe').css('height',h+'px');
